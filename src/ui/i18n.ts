...
export const UI: Record<Lang, Record<string, string>> = {
  en: {
    ...
    compassN: "N", langToggle: "한국어", home: "🏠 Home", scaleFoot: "≈{n} days on foot",
  },
  ko: {
    ...
    compassN: "북", langToggle: "EN", home: "🏠 홈", scaleFoot: "도보 약 {n}일",
  },
};
...
export const PLAY_UI: Record<Lang, Record<string, string>> = {
  en: {
    ...
    tipChalBlitz: "Grow your realm to 1.5× its starting size by year 200.",
    tipChalPhoenix: "Be driven down to a third of your starting realm, then rebuild to near its former size.",
  ...
  ko: {
    ...
    tipChalBlitz: "200년 안에 영토를 시작 크기의 1.5배로 키우세요.",
    tipChalPhoenix: "영토가 시작 크기의 1/3까지 몰렸다가 원래 규모 가까이 회복하세요.",
