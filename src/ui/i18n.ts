...
export const UI: Record<Lang, Record<string, string>> = {
  en: {
    ...
    roadBetween: "Road, {a} – {b}, {km} km",
    mapOf: "Map of", cityList: "Cities", cityListHint: "Open a city plan",
    factRealm: "Realm", factKind: "Kind", factPeople: "People", factNear: "Nearby", factUnclaimed: "unclaimed", factFounded: "Founded", factAncient: "before the chronicle",
    rank1: "Hamlet", rank2: "Village", rank3: "Market town", rank4: "Town", rank5: "City", rank6: "Great city",
    kind_coastalPort: "a port on the coast", kind_bridgeTown: "a bridge town on the river",
    kind_hilltopFortress: "a fortress on the height", kind_meanderDefense: "a town in the river's bend",
    kind_plainsMarket: "a market town on open ground", kind_forestGrove: "a timber town in the forest",
    kind_marshStilt: "a town on stilts in the marsh", kind_desertOasis: "an oasis town in the desert",
    kind_hillside: "a town on the hillside", kind_spur: "a town on the spur",
    kind_valleyPass: "a town holding the pass", walkDays: "{d} days on foot", walkDay: "a day on foot", advanced: "World settings",
    seaLevel: "Sea level", mountainLevel: "Mountains", polityCount: "Nations", townCount: "Towns", cellCount: "Detail", year: "{y} AY", legendProvinces: "Provinces", keyProvinceBorder: "Province", keyRealmBorder: "Realm", keySeat: "Seat", keyRoad: "Road", viewTerrain: "Terrain: biomes, rivers, mountains and coasts, with the regions and settlements named.",
    ...
    legendTerrain: "Terrain", legendRealms: "Realms", legendCultures: "Cultures", legendDistricts: "Districts", legendPlate: "Key", gateTo: "Gate to {towns}",
    roadTo: "to {towns}",
  ...
  ko: {
    ...
    roadBetween: "{a}–{b} 길 · {km}km",
    mapOf: "지도 —", cityList: "도시", cityListHint: "도시 도면 열기",
    factRealm: "소속", factKind: "성격", factPeople: "인구", factNear: "인근", factUnclaimed: "무주지", factFounded: "건설", factAncient: "연대기 이전",
    rank1: "촌락", rank2: "마을", rank3: "장이 서는 읍", rank4: "도시", rank5: "대도시", rank6: "거대 도시",
    kind_coastalPort: "해안의 항구 도시", kind_bridgeTown: "강을 건너는 다리 도시",
    kind_hilltopFortress: "고지의 요새 도시", kind_meanderDefense: "강굽이가 감싼 도시",
    kind_plainsMarket: "평원의 장터 도시", kind_forestGrove: "숲속의 목재 도시",
    kind_marshStilt: "늪 위 고상 가옥 도시", kind_desertOasis: "사막의 오아시스 도시",
    kind_hillside: "산비탈의 도시", kind_spur: "산줄기 끝의 도시",
    kind_valleyPass: "고갯길을 지키는 도시", walkDays: "도보 {d}일", walkDay: "도보 하루", advanced: "세계 설정",
    seaLevel: "해수면", mountainLevel: "산맥", polityCount: "국가 수", townCount: "도시 수", cellCount: "정밀도", year: "{y}년", legendProvinces: "영토", keyProvinceBorder: "영토 경계", keyRealmBorder: "국경", keySeat: "중심지", keyRoad: "길", viewTerrain: "지형: 생물군계·강·산맥·해안, 지역명과 도시 표시.",
    ...
    legendTerrain: "지형", legendRealms: "나라", legendCultures: "문화", legendDistricts: "구역", legendPlate: "범례", gateTo: "{towns} 방면 성문",
    roadTo: "{towns} 방면",
