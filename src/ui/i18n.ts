...
export const UI: Record<Lang, Record<string, string>> = {
  en: {
    ...
    factRealm: "Realm", factKind: "Kind", factPeople: "People", factNear: "Nearby", factUnclaimed: "unclaimed",
  ...
  ko: {
    ...
    factRealm: "소속", factKind: "성격", factPeople: "인구", factNear: "인근", factUnclaimed: "무주지",
