...
export const PLAY_UI: Record<Lang, Record<string, string>> = {
  en: {
    ...
    ascBadge: "⬆ Ascension {n}", ascTip: "{n} wins on this world — every rival's cohesion regenerates {n} steps faster.",
  ...
  ko: {
    ...
    ascBadge: "⬆ 상승 {n}", ascTip: "이 세계에서 {n}승 — 모든 라이벌의 결속 회복이 {n}단계 강해집니다.",
