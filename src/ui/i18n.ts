...
export const UI: Record<Lang, Record<string, string>> = {
  en: {
    ...
    mapOf: "Map of", year: "{y} AY", legendProvinces: "Provinces", keyProvinceBorder: "Province", keyRealmBorder: "Realm", keySeat: "Seat", viewTerrain: "Terrain: biomes, rivers, mountains and coasts, with the regions and settlements named.",
  ...
  ko: {
    ...
    mapOf: "지도 —", year: "{y}년", legendProvinces: "영토", keyProvinceBorder: "영토 경계", keyRealmBorder: "국경", keySeat: "중심지", viewTerrain: "지형: 생물군계·강·산맥·해안, 지역명과 도시 표시.",
