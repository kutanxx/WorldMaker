...
export const PLAY_UI: Record<Lang, Record<string, string>> = {
  en: {
    ...
    attackPlaceholder: "— ⚔ attack a region —", investPlaceholder: "— 💰 invest cohesion —",
    foundPlaceholder: "— 🏘 found a city —", peacePlaceholder: "— 🕊 sue for peace —",
    investRealmOpt: "realm", investFrontierOpt: "frontier",
    tipAttack: "Seize the marked region from a neighbour. Only ✓ targets succeed — you take every tinted cell.",
    tipInvest: "Instantly raise cohesion (one-off, then decays normally). Frontier feeds your battles; realm staves off civil war.",
    tipFound: "Found a city on a gold cell. While you hold it: a cohesion floor and a combat bonus around it, permanently.",
  ...
  ko: {
    ...
    attackPlaceholder: "— ⚔ 구역 공격 —", investPlaceholder: "— 💰 결속 투자 —",
    foundPlaceholder: "— 🏘 도시 건설 —", peacePlaceholder: "— 🕊 강화 요청 —",
    investRealmOpt: "전국", investFrontierOpt: "국경",
    tipAttack: "이웃의 표시된 구역을 점령합니다. ✓ 목표만 성공 — 칠해진 구역 전체를 얻습니다.",
    tipInvest: "영지 결속을 즉시 올립니다(일회성, 이후 자연 감쇠). 국경 = 전투 직결, 전국 = 내전 예방.",
    tipFound: "금색 셀에 도시를 세웁니다. 소유하는 동안 일대의 결속 바닥 + 전투 보너스(영구).",
