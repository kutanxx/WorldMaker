...
export const UI: Record<Lang, Record<string, string>> = {
  en: {
    ...
    seaLevel: "Sea level", mountainLevel: "Mountains", polityCount: "Nations", townCount: "Towns", cellCount: "Detail", year: "{y} AY", legendProvinces: "Provinces", keyProvinceBorder: "Province", keyRealmBorder: "Realm", keySeat: "Seat", viewTerrain: "Terrain: biomes, rivers, mountains and coasts, with the regions and settlements named.",
  ...
  ko: {
    ...
    seaLevel: "해수면", mountainLevel: "산맥", polityCount: "국가 수", townCount: "도시 수", cellCount: "정밀도", year: "{y}년", legendProvinces: "영토", keyProvinceBorder: "영토 경계", keyRealmBorder: "국경", keySeat: "중심지", viewTerrain: "지형: 생물군계·강·산맥·해안, 지역명과 도시 표시.",
