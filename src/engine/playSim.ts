...
import { initSim, stepSim, aggregate, buildStraitLinks, buildSeaLanes, STRAIT_HOPS, ASCENSION_CAP, TICKS, YEARS_PER_TICK, type SimState, type Stance, type HistoryEvent } from "./historySim";
