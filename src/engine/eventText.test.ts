...
describe("eventText — Korean is byte-identical to what the simulation used to write", () => {
  ...
  it("reproduces seed 1's chronicle line for line", () => {
    ...
    expect(h.events.map((e) => eventText(e, h.polities, "ko"))).toEqual([
      ...
      "50년, Khaak이 Grar 건설",
      "60년, Khaak이 Saiashaish 건설",
      "90년, Zaiashain이 Khaak을 정복",
      "90년, 내란이 Laelmaer을 Riadiar·Thiarbrork으로 쪼갬",
      "90년, Thiarbrork이 Elarsyean 건설",
      "130년, 자유도시 Hreir 독립 선포",
      "130년, Riadiar이 Syeansyean 건설",
      "140년, Riadiar이 Meliaelaea 건설",
      "150년, Thiarbrork 황금기 도래",
      "250년, Thruthkhagg 황금기 도래",
      "260년, 자유도시 Zazsaiash 독립 선포",
      "260년, Thiarbrork이 Vaeathliei 건설",
      "270년, 내란이 Zaiashain을 Stirkfand·Miarand으로 쪼갬",
      "300년, Miarand이 Saar 건설",
      "320년, Zaiashain이 Dhaishdhar을 정복",
      "320년, Stirkfand이 Zazsaiash 건설",
      "340년, Miarand이 Dhaazaih 건설",
      "350년, Stirkfand이 Liermiol 건설",
      "360년, Miarand이 Aelmeir 건설",
      "380년, 내란이 Zaiashain을 Lundbris·Staethfoum으로 쪼갬",
      "380년, Staethfoum 황금기 도래",
      "380년, Zaiashain이 Zarair 건설",
      "400년, 자유도시 Coriorvean 독립 선포",
      "400년, Stirkfand이 Corais 건설",
      "410년, Stirkfand이 Drur 건설",
      "420년, Zaiashain이 Miarand을 정복",
      "420년, Staethfoum이 Thykhy 건설",
      "430년, Zaiashain이 Ceusdu를 정복",
      "440년, Lundbris이 Hreir 건설",
...
describe("eventText — English", () => {
  it("tells seed 1's chronicle in the gazetteer's own voice", () => {
    ...
    expect(h.events.map((e) => eventText(e, h.polities, "en"))).toEqual([
      ...
      "Year 60 — Khaak founds Saiashaish",
      "Year 90 — Zaiashain conquers Khaak",
      "Year 90 — civil war splits Laelmaer into Riadiar and Thiarbrork",
      "Year 90 — Thiarbrork founds Elarsyean",
      "Year 130 — the free city of Hreir declares independence",
      "Year 130 — Riadiar founds Syeansyean",
      "Year 140 — Riadiar founds Meliaelaea",
      "Year 150 — a golden age dawns in Thiarbrork",
      "Year 250 — a golden age dawns in Thruthkhagg",
      "Year 260 — the free city of Zazsaiash declares independence",
      "Year 260 — Thiarbrork founds Vaeathliei",
      "Year 270 — civil war splits Zaiashain into Stirkfand and Miarand",
      "Year 300 — Miarand founds Saar",
      "Year 320 — Zaiashain conquers Dhaishdhar",
      "Year 320 — Stirkfand founds Zazsaiash",
      "Year 340 — Miarand founds Dhaazaih",
      "Year 350 — Stirkfand founds Liermiol",
      "Year 360 — Miarand founds Aelmeir",
      "Year 380 — civil war splits Zaiashain into Lundbris and Staethfoum",
      "Year 380 — a golden age dawns in Staethfoum",
      "Year 380 — Zaiashain founds Zarair",
      "Year 400 — the free city of Coriorvean declares independence",
      "Year 400 — Stirkfand founds Corais",
      "Year 410 — Stirkfand founds Drur",
      "Year 420 — Zaiashain conquers Miarand",
      "Year 420 — Staethfoum founds Thykhy",
      "Year 430 — Zaiashain conquers Ceusdu",
      "Year 440 — Lundbris founds Hreir",
